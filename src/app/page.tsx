...
import { Mail, Phone, MapPin, Link as LinkIcon, Download, GraduationCap, Award, BookOpen, Star, ChevronRight } from "lucide-react";
      ...
      <section id="about" className="hero-section hero-flex flex justify-between gap-8 items-center relative" style={{ paddingTop: '6rem', paddingBottom: '4rem' }}>
        <ClientTilt className="glass-panel animate-sophisticated" style={{ flex: 1, padding: '4rem 3rem' }}>
          ...
          <div id="contact" className="contact-links mt-8 animate-sophisticated delay-3">
            <a href="mailto:ys6463@srmist.edu.in" className="contact-link badge hover:scale-105 transition-transform duration-300 reveal" style={revealStyle(0)}>
              <Mail size={16} /> ys6463@srmist.edu.in
            </a>
            <span className="contact-link badge hover:scale-105 transition-transform duration-300 reveal" style={revealStyle(1)}>
              <Phone size={16} /> +91-7061293059
            </span>
            <span className="contact-link badge hover:scale-105 transition-transform duration-300 reveal" style={revealStyle(2)}>
              <MapPin size={16} /> Tiruchirappalli, TN, India
            </span>
            <a href="https://linkedin.com/in/yash-pratap-singh-b43925327/" target="_blank" rel="noreferrer" className="contact-link badge hover:scale-105 transition-transform duration-300 reveal" style={revealStyle(3)}>
